...
public class EntrySet {
     ...
     */
    public void computeMinMax(int start, int end, List<com.testreactnativeapp.ikvstockchart.entry.StockIndex> stockIndexList) {
        int endValue;
        if (end < 2 || end >= entries.size()) {
            endValue = entries.size() - 1;
        } else {
        ...
        if (stockIndexList != null) {
            for (com.testreactnativeapp.ikvstockchart.entry.StockIndex stockIndex : stockIndexList) {
